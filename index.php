            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-12 md:gap-y-20">
                ...
                <div class="flex flex-col gap-6 group hover-trigger cursor-pointer">
                    <div class="overflow-hidden rounded-2xl aspect-[16/10] bg-gray-50 border border-gray-100">
                        <img src="images/projects/project1.png" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105">
                    </div>
                    <div class="flex flex-col gap-4 px-2 text-left">
                        <span class="inline-block bg-gray-100 text-gray-500 text-[10px] font-bold px-4 py-1.5 rounded-full uppercase tracking-widest w-fit">ECOM | UI/UX DESIGN</span>
                        <h3 class="text-[1.25rem] md:text-3xl font-medium text-gray-900 leading-tight">
                            Transforming the Rudraksha & Gemstone Ordering Journey with a Seamless UX Overhaul
                        </h3>
                ...
                <div class="flex flex-col gap-6 group hover-trigger cursor-pointer">
                    <div class="overflow-hidden rounded-2xl aspect-[16/10] bg-gray-50 border border-gray-100">
                        <img src="images/projects/project2.png" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105">
                    </div>
                    <div class="flex flex-col gap-4 px-2 text-left">
                        <span class="inline-block bg-gray-100 text-gray-500 text-[10px] font-bold px-4 py-1.5 rounded-full uppercase tracking-widest w-fit">ECOM | UI/UX DESIGN</span>
                        <h3 class="text-[1.25rem] md:text-3xl font-medium text-gray-900 leading-tight">
                            Redesigning the Luxury Beauty Experience for Organity Skin Care
                        </h3>
                        <button class="group bg-[#0f172a] text-white px-6 py-3 md:px-8 md:py-4 rounded-full font-bold text-xs md:text-sm w-fit transition-all hover:bg-black overflow-hidden uppercase">
                            <div class="relative overflow-hidden h-4 md:h-5">
                                <span class="block transition-transform duration-500 group-hover:-translate-y-full">Read Case Study</span>
                ...
                <div class="flex flex-col gap-6 group hover-trigger cursor-pointer">
                    ...
                    <div class="flex flex-col gap-4 px-2 text-left">
                        <span class="inline-block bg-gray-100 text-gray-500 text-[10px] font-bold px-4 py-1.5 rounded-full uppercase tracking-widest w-fit">ECOM | UI/UX DESIGN</span>
                        <h3 class="text-[1.25rem] md:text-3xl font-medium text-gray-900 leading-tight">
                            Enhancing Digital Presence for Veda Rudraksha Global
                        </h3>
                        <button class="group bg-[#0f172a] text-white px-6 py-3 md:px-8 md:py-4 rounded-full font-bold text-xs md:text-sm w-fit transition-all hover:bg-black overflow-hidden uppercase">
                            <div class="relative overflow-hidden h-4 md:h-5">
                                <span class="block transition-transform duration-500 group-hover:-translate-y-full">Read Case Study</span>
                ...
                <div class="flex flex-col gap-6 group hover-trigger cursor-pointer">
                    ...
                    <div class="flex flex-col gap-4 px-2 text-left">
                        <span class="inline-block bg-gray-100 text-gray-500 text-[10px] font-bold px-4 py-1.5 rounded-full uppercase tracking-widest w-fit">ECOM | UI/UX DESIGN</span>
                        <h3 class="text-[1.25rem] md:text-3xl font-medium text-gray-900 leading-tight">
                            Digital Branding and Interface Design for Premium Organity Products
                        </h3>
                        <button class="group bg-[#0f172a] text-white px-6 py-3 md:px-8 md:py-4 rounded-full font-bold text-xs md:text-sm w-fit transition-all hover:bg-black overflow-hidden uppercase">
                            <div class="relative overflow-hidden h-4 md:h-5">
                                <span class="block transition-transform duration-500 group-hover:-translate-y-full">Read Case Study</span>
